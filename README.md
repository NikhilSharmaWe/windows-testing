...
Sonobuoy can be used to run tests on windows nodes. Checkout for [Running E2E Tests On Windows Clusters](https://sonobuoy.io/windows-e2e-tests-with-sonobuoy/) reference.
